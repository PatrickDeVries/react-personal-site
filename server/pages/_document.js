...
const Body = styled_components__WEBPACK_IMPORTED_MODULE_1___default().body.withConfig({
  displayName: "_document__Body",
  componentId: "sc-qpmtbn-0"
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_0__.default {
  static getInitialProps({
    ...
    const page = renderPage(App => props => sheet.collectStyles( /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx(App, _objectSpread({}, props)))); // Step 3: Extract the styles as <style> tags
